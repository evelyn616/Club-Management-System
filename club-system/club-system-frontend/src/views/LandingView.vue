...
<style scoped>
/* 這裡直接引用與 DashBoard 相同的 Style，保持設計系統一致 */
...
/* 這裡省略重複的 .dashboard, .navbar, .hero-section 等 CSS 樣式，
   請確保將 DashBoard 的 <style scoped> 內容完整複製到這裡 */
...
/* 確保 Hero 圖片背景適合 Landing 氛圍 */
.hero-bg {
  background-image: url('https://images.unsplash.com/photo-1523240795612-9a054b0db644?q=80&w=2070&auto=format&fit=crop'); /* 換一張社團氛圍的圖 */
}
